...
const inputProducts = document.querySelector(".js-input-products");
...
const selectProduct = (index) => {
  const productIdToSelect = filteredProducts[index].id;
  const productItemContainerToSelect = document.getElementById(productIdToSelect);
  productItemContainerToSelect.style.backgroundColor = "rgb(83, 135, 214)";
